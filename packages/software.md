# Software Development Skills Package / 软件开发技能包

## Included Skills / 包含技能

This package includes 6 expert skills for software development:
<!-- 本技能包包含 6 个软件开发专家技能：-->

1. **Software Architect** - System design, patterns, scalability
2. **DevOps Engineer** - CI/CD, cloud-native, SRE
3. **Algorithm Engineer** - Data structures, algorithms
4. **Security Engineer** - Application security, penetration testing
5. **Data Scientist** - ML, statistics, visualization
6. **Skill Dev Expert** - Skill development best practices
