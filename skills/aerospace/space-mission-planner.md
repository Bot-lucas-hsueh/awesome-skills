...
|----------|---------------------|
| **Claude Code** | `Read https://theneoai.github.io/awesome-skills/skills/aerospace/space-mission-planner.md and install` |
| **OpenCode** | `Read https://theneoai.github.io/awesome-skills/skills/aerospace/space-mission-planner.md and install` |
...
| **Kimi Code** | `读取 https://theneoai.github.io/awesome-skills/skills/aerospace/space-mission-planner.md 并安装` |
...
| **Skill Path** | `skills/aerospace/space-mission-planner.md` |
