...
Input: Handle standard rocket chief designer request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex rocket chief designer scenario with multiple stakeholders
