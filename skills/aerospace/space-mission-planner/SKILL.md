...
Input: Handle standard space mission planner request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex space mission planner scenario with multiple stakeholders
