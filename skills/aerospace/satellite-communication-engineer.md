...
|----------|---------------------|
| **Claude Code** | `Read https://theneoai.github.io/awesome-skills/skills/aerospace/satellite-communication-engineer.md and install` |
| **OpenCode** | `Read https://theneoai.github.io/awesome-skills/skills/aerospace/satellite-communication-engineer.md and install` |
...
| **Kimi Code** | `读取 https://theneoai.github.io/awesome-skills/skills/aerospace/satellite-communication-engineer.md 并安装` |
...
### Quick Install
```
Read https://theneoai.github.io/awesome-skills/skills/aerospace/satellite-communication-engineer.md and install
```
...
| **Skill Path** | `skills/aerospace/satellite-communication-engineer.md` |
