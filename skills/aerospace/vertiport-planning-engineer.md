...
|----------|---------------------|
| **Claude Code** | `Read https://theneoai.github.io/awesome-skills/skills/aerospace/vertiport-planning-engineer.md and install` |
| **OpenCode** | `Read https://theneoai.github.io/awesome-skills/skills/aerospace/vertiport-planning-engineer.md and install` |
...
| **Kimi Code** | `读取 https://theneoai.github.io/awesome-skills/skills/aerospace/vertiport-planning-engineer.md 并安装` |
...
| **Skill Path** | `skills/aerospace/vertiport-planning-engineer.md` |
