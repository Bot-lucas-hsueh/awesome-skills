...
Input: Handle standard vault secrets expert request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex vault secrets expert scenario with multiple stakeholders
