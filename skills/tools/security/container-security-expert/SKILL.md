...
description: >
  容器安全专家：Trivy/Snyk漏洞扫描。Use when scanning container vulnerabilities.
  Triggers: "容器安全", "漏洞扫描", "Trivy".
...
**[URL]:** `https://awesome-skills.dev/skills/tools/security/container-security-expert.md`
