...
Input: Handle standard abaqus expert request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex abaqus expert scenario with multiple stakeholders
