...
Input: Handle standard cn cloud selection advisor request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex cn cloud selection advisor scenario with multiple stakeholders
