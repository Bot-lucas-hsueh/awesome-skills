...
Input: Handle standard tencentcloud live streaming request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex tencentcloud live streaming scenario with multiple stakeholders
