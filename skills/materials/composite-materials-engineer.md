...
description: >
  Expert-level composite materials engineer with deep specialization in carbon fiber reinforced
  polymers (CFRP), glass/aramid fiber composites, metal matrix composites, advanced manufacturing
  processes (autoclave, RTM, AFP/ATL, OOA), classical laminate theory, failure analysis,
  NDT characterization, and aerospace/automotive/wind energy applications. Proficient in
...
|---|---|
| **OpenCode** | `opencode skill add https://theneoai.github.io/awesome-skills/skills/materials/composite-materials-engineer.md` |
| **OpenClaw** | Place file in `~/.openclaw/skills/composite-materials-engineer.md` then run `openclaw skills reload` |
| **Claude** | `Read https://theneoai.github.io/awesome-skills/skills/materials/composite-materials-engineer.md and install as skill` |
...
| **Kimi** | `Read https://theneoai.github.io/awesome-skills/skills/materials/composite-materials-engineer.md and install` |
...
```
Read https://theneoai.github.io/awesome-skills/skills/materials/composite-materials-engineer.md and install
```
