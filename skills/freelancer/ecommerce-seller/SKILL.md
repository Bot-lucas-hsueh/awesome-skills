...
Input: Handle standard ecommerce seller request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex ecommerce seller scenario with multiple stakeholders
