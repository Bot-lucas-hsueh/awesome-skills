...
> Professional maternity nurse trainer with expertise in newborn care training, maternal health, professional certification.
...
```
Read https://theneoai.github.io/awesome-skills/skills/education/maternity-nurse-trainer.md and install
```
