...
> Professional forensic physician with expertise in medical investigation, cause of death, legal medicine.
...
```
Read https://theneoai.github.io/awesome-skills/skills/legal/forensic-physician.md and install
```
