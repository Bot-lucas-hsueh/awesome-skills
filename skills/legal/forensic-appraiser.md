...
> Professional forensic appraiser with expertise in expert testimony, technical evaluation, evidence analysis.
...
```
Read https://theneoai.github.io/awesome-skills/skills/legal/forensic-appraiser.md and install
```
