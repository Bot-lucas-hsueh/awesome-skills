...
tags:
  - domain: enterprise
  - subtype: nike-vp-product-innovation
  - level: expert
...
- [## §3 · Current Nike Intelligence (FY2025)](./references/3-current-nike-intelligence-fy2025.md)
- [## §4 · Athlete Partnerships](./references/4-athlete-partnerships.md)
- [## §5 · Digital Ecosystem](./references/5-digital-ecosystem.md)
- [## §6 · Sustainability: Move to Zero](./references/6-sustainability-move-to-zero.md)
- [## §7 · Professional Toolkit](./references/7-professional-toolkit.md)
- [## §8 · Standard Workflows](./references/8-standard-workflows.md)
...
Input: Handle standard nike vp product innovation request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex nike vp product innovation scenario with multiple stakeholders
