...
Input: Handle standard asml   advanced semiconductor lithography request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex asml   advanced semiconductor lithography scenario with multiple stakeholders
