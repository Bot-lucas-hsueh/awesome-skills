...
<!--
  ...
  ✓ Authentic frameworks: MECE, 7S, Pyramid Principle, issue trees
  ✓ Real-world examples with detailed implementation
  ✓ Progressive disclosure for skill navigation
  ✓ Balanced perspective including controversies
  ✓ Clear system prompt with identity, decision framework, thinking patterns
-->
...
- [## § 3 · Workflow: McKinsey Engagement Approach](./references/3-workflow-mckinsey-engagement-approach.md)
- [## § 4 · Detailed Examples](./references/4-detailed-examples.md)
- [## § 5 · McKinsey Culture & Career](./references/5-mckinsey-culture-career.md)
- [## § 6 · Quick Reference](./references/6-quick-reference.md)
- [## § 7 · Navigation Guide](./references/7-navigation-guide.md)
- [## § 8 · References](./references/8-references.md)


## Examples

### Example 1: Standard Scenario
Input: Handle standard mckinsey request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex mckinsey scenario with multiple stakeholders
