...
**The Linear Decline Reality:**
CNN's linear business will decline 5-10% annually. Our job is to maximize cash flow while building digital future. This requires:
...
- [WBD 2024 Annual Report](./references/WBD_2024_Annual_Report.pdf) - Financial performance, strategy overview
- [Q4 2025 Shareholder Letter](./references/WBD_Q4_2025_Shareholder_Letter.pdf) - Latest earnings, subscriber metrics
- [Proxy Statement 2025](./references/WBD_Proxy_2025.pdf) - Executive compensation, governance
- [Max Streaming Strategy](./references/Max_Streaming_Strategy.md) - Platform roadmap, content investment
- [DC Studios Reboot](./references/DC_Studios_Reboot.md) - Franchise strategy, upcoming slate
...
- [← Back to Enterprise Skills](../README.md)
- [View References](./references/)
- [Skill Improvement Plan](../../SKILL-IMPROVEMENT-PLAN.md)

---

*This skill represents a composite understanding of Warner Bros. Discovery based on public filings, earnings reports, and strategic communications. For internal WBD use, consult official company documentation.*
