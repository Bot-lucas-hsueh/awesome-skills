...
tags:
  - domain: enterprise
  - subtype: bhp-group-limited-skill
  - level: expert
...
Input: Handle standard bhp group limited skill request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex bhp group limited skill scenario with multiple stakeholders
