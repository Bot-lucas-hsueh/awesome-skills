...
Input: Handle standard tencent gaas manager request with standard procedures
...
### Example 2: Edge Case
Input: Manage complex tencent gaas manager scenario with multiple stakeholders
