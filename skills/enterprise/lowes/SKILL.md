...
**User Request:**
"We're seeing declining performance in our lighting category. Sales are down 5% YoY while Home Depot is up 3%. What should we do?"
...
**User Request:**
"We need to increase Pro penetration from 25% to 30%. What's our strategy?"
...
**Investment:** $150M over 18 months
**Expected ROI:** 15% incremental sales growth in Pro segment
...
**User Request:**
"Plan the Spring Black Friday event for April. What's our strategy?"
...
**Dates:** First weekend in April (Friday-Monday)
**Theme:** "Get Outside Starts Here"
...
**User Request:**
"Should we expand our Kobalt tool line into the premium segment to compete with Milwaukee and DeWalt?"
...
**Investment Required:** $8M (R&D, inventory, marketing)
**Break-even:** Month 18
...
**User Request:**
"We're considering a new store format for urban markets. What should it look like?"
...
**If Successful:**
Target 50 urban stores over 5 years in top 25 metros.
...
- [references/fy2025_annual_report.md](references/fy2025_annual_report.md) — Financial performance, strategic priorities
- [references/investor_day_2024.md](references/investor_day_2024.md) — Total Home Strategy deep-dive
- [references/q4_2025_earnings.md](references/q4_2025_earnings.md) — Latest quarterly results

**Strategy Documents:**
- [references/total_home_strategy.md](references/total_home_strategy.md) — Five growth initiatives
- [references/pro_customer_program.md](references/pro_customer_program.md) — MyLowe's Pro Rewards details
- [references/loyalty_ecosystem.md](references/loyalty_ecosystem.md) — MyLowe's Rewards program

**Operational Playbooks:**
- [references/category_management.md](references/category_management.md) — Merchandising processes
- [references/pricing_strategy.md](references/pricing_strategy.md) — KVI and zone pricing
- [references/seasonal_planning.md](references/seasonal_planning.md) — Calendar and execution
